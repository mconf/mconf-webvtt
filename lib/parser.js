...
/**
 * Using NOTE as a custom extra structure for cues
 *
 * NOTE MCONF_CUE_META {"author":"","revised":false,"comments":""}
 */
 ...
 *
 * @returns {object} cue Cue object with start, end, text, styles and note.
 *
 */
function parseCue (cue, i) {
  ...
  return { identifier, start, end, text, styles, meta };
}
